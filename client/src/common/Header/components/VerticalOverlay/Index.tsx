...
// Styles
import { StyledOverlay, StyledOverlayContent, OverlayActions, OverlaySocialLinks, ListItemWrapper, StyledOverlayAction, StyledLink, StyledExternalLink } from './Index.style';
    ...
    <StyledOverlay>
        <StyledOverlayContent>
            <OverlayActions fadeout={toggled}>
                <ListItemWrapper>
                    <StyledLink to="/news" $verticaltext={true}>
                        <LinkText>Campus News</LinkText>
                    </StyledLink>
                </ListItemWrapper>
                <ListItemWrapper>
                    <StyledLink to="/about-us" $verticaltext={true}>
        ...
        <StyledOverlayAction>
            <StyledLink to="/contact-us" $verticaltext={false}>
